...
class ChestWorkoutScreen extends StatefulWidget {
  ...
  @override
  State<ChestWorkoutScreen> createState() => ChestWorkoutScreenState();
}

class ChestWorkoutScreenState extends State<ChestWorkoutScreen> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Image(image:  AssetImage('assets/fitness app/images/chest 2.png'),fit: BoxFit.fill,),
            )
          ],
        ),
      ),
               ...
               Row(
                children: [
                  const Padding(
                    ...
                    child: Text('Chest Workout',style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),),
                  ),
                  SizedBox(
