...
class LowerbodyWorkoutScreen extends StatefulWidget {
  LowerbodyWorkoutScreen({super.key});

  @override
  State<LowerbodyWorkoutScreen> createState() => LowerbodyWorkoutScreenState();
}

class LowerbodyWorkoutScreenState extends State<LowerbodyWorkoutScreen> {
               ...
               Row(
                children: [
                  const Padding(
                    ...
                    child: Text('Lowerbody Workout',style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),),
                  ),
                  SizedBox(
